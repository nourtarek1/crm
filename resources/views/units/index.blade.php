...
@endsection
<input id="my_route" value={{ route('units.destroy', '') }} class="d-none">
    ...
    @section('js')
        <script>
            ('#deleteModal').on('show.bs.modal', function(event) {
                ...
                var units_id = button.data('unitsid')

                var modal = $(this)
                modal.find('form').attr('action', $("#my_route").val() + "/" + units_id);
            })
        </script>
