...
@endsection
<input id="my_route" value={{ route('select.destroy', '') }} class="d-none">
...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                                ...
                                <table class="table table-bordered" id="myTable" data-page-length='50'
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="wd-20p border-bottom-0"> key</th>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($selects as $select)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('select.edit',$select->id)}}"><i
                                                            class="fa fa-edit"></i></a>
                                                    <a href="#" data-toggle="modal" data-target="#deleteModal"
                                                        data-selectid="{{ $select['id'] }}"><i
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form method="POST" action="{{ route('select.destroy', $select->id) }}">
                    @method('DELETE')
                    @csrf
    ...
    <script>
        ('#deleteModal').on('show.bs.modal', function(event) {
            ...
            var select_id = button.data('selectid')

            var modal = $(this)
            // modal.find('.modal-footer #user_id').val(user_id)
            modal.find('form').attr('action', $("#my_route").val() + "/" + select_id);
        })
    </script>
